        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 text-left">
            <div className="space-y-4">
              ...
              <p className="font-montserrat text-sm leading-relaxed text-[hsl(var(--muted-foreground))]">
                Я верила, что настоящее счастье приходит неожиданно — именно так и случилось.
                В конце июня, когда лето было в самом разгаре, в мою жизнь вошёл человек,
                который стал для меня целым миром. С тех пор каждый день наполнен теплом,
                смехом и ощущением, что всё идёт именно так, как должно.
              </p>
            </div>
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-full bg-[hsl(var(--blush))] flex items-center justify-center mb-6">
              ...
              <p className="font-montserrat text-sm leading-relaxed text-[hsl(var(--muted-foreground))]">
                Говорят, судьба умеет удивлять. Июньским вечером 2025 года я встретил Марию —
                и с первых минут почувствовал, что эта встреча особенная. Она изменила всё:
                моё утро, мои планы, моё будущее. Теперь я знаю точно — это именно тот человек,
                с которым хочу пройти весь путь.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 bg-[hsl(var(--cream))] rounded-3xl p-10 border border-[hsl(var(--blush))]">
            ...
            <p className="font-cormorant italic text-2xl text-[hsl(var(--dark))] leading-relaxed">
              «Мы встретились в конце июня 2025 года — когда лето пахнет свободой
              и всё вокруг располагает к чему-то новому. Это была та самая встреча,
              о которой не забывают. Через год мы говорим друг другу "да" —
              и хотим разделить этот момент с теми, кто нам дорог.»
            </p>
          </div>
        </div>
      </section>
